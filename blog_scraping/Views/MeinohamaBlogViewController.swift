//
//  MeinohamaBlogViewController.swift
//  blog_scraping
//
...
class MeinohamaBlogViewController: UIViewController {
...
extension MeinohamaBlogViewController: UITableViewDelegate, UITableViewDataSource{
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return blogs.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "meinohamaCell", for: indexPath)
